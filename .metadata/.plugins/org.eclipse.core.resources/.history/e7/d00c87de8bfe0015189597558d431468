...
generic/AJAX.hex: generic/AJAX.elf
	"d:/Users/simtech/.arduinocdt/packages/esp8266/tools/esptool/0.4.8/esptool" -eo "d:\Users\simtech\.arduinocdt\packages\esp8266\hardware\esp8266\esp8266\2.1.0/bootloaders/eboot/eboot.elf" -bo "generic/AJAX.bin" -bm dio -bf 40 -bz 512K -bs .text -bp 4096 -ec -eo "generic/AJAX.elf" -bs .irom0.text -bs .text -bs .data -bs .rodata -bc -ec

generic/AJAX.elf: $(PROJECT_OBJS) $(LIBRARIES_OBJS) generic/core.a
	"d:/Users/simtech/.arduinocdt/packages/esp8266/tools/xtensa-lx106-elf-gcc/1.20.0-26-gb404fb9-2/bin/xtensa-lx106-elf-gcc" -g -w -Os -nostdlib -Wl,--no-check-sections -u call_user_start -Wl,-static "-Ld:\Users\simtech\.arduinocdt\packages\esp8266\hardware\esp8266\esp8266\2.1.0/tools/sdk/lib" "-Ld:\Users\simtech\.arduinocdt\packages\esp8266\hardware\esp8266\esp8266\2.1.0/tools/sdk/ld" "-Teagle.flash.512k64.ld" -Wl,--gc-sections -Wl,-wrap,system_restart_local -Wl,-wrap,register_chipv6_phy  -o "generic/AJAX.elf" -Wl,--start-group $(PROJECT_OBJS) $(LIBRARIES_OBJS) "generic/arduino.ar" -lm -lgcc -lhal -lphy -lpp -lnet80211 -llwip -lwpa -lcrypto -lmain -lwps -laxtls -lsmartconfig -lmesh -lwpa2 -Wl,--end-group  "-Lgeneric"
...
size:
	"d:/Users/simtech/.arduinocdt/packages/esp8266/tools/xtensa-lx106-elf-gcc/1.20.0-26-gb404fb9-2/bin/xtensa-lx106-elf-size" -A "generic/AJAX.elf"

generic/project/AJAX.cpp.o: ../AJAX.cpp generic/project/AJAX.cpp.d
	@$(call mymkdir,$(dir $@))
...
generic/project/AJAX.cpp.d: ;

-include generic/project/AJAX.cpp.d 
